...
const LatestProjects = () => {
  ...
  return (
    <div
      className="w-full md:min-h-auto min-h-screen flex flex-col items-center justify-start py-12 md:py-20 px-4 md:px-8 bg-black/50 md:bg-black/0 overflow-hidden"
      id="latest-projects"
    >
